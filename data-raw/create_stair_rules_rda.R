...
, destination = c( "Common areas of collective residential buildings and individual houses" # "Parties communes des batiments d'habitation collectifs et des maisons individuelles"
  ...
  , height_max = c(17, 18, 16, 16, 17, 21)
  , going_min =  c(28 , 24, 28, 28, 36, 19)
  , height_min = c( NA, NA, NA, NA, 13, NA )
  , going_max = c( NA, NA, NA, NA, 36, NA )
  , blondel_min = c( NA, NA, NA, NA, 60, NA )
  , blondel_max = c( NA, NA, NA, NA, 64, NA )

  , source = c("Arrêté du 24 décembre 2015, article 6-1"
  , "Arrêté du 24 décembre 2015, article 12-1"
  , "Arrêté du 20 avril 2017, article 7-1"
  , "Arrêté du 27 juin 1994, article 4"
  , "Arrêté du 23 mars 1965, article 3"
...
, url = c("https://www.legifrance.gouv.fr/loda/id/JORFTEXT000031692481"
 ...
 , source_type = c( "regulation", "regulation", "regulation", "regulation", "regulation", "standard" )
