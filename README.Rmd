...
> The Blondel value used as a reference by `solve_stairs` (63 cm) reflect the traditional French stair geometry criteria and does not allow compliance with most of the proposed standards when risers heights > 17 cm are adopted. 
